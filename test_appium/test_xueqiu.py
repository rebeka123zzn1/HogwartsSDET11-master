...
# """hogwarts"
    ...
    def test_search_and_get_price_from_hk(self):
        ...
        sleep(2)
        self.driver.find_element(MobileBy.ID, "name").click()
        #com.xueqiu.android:id/title_container
    ...
    def test_add_attention(self):
        ...
        self.driver.find_element(*stock).click()
        #add_button
        # addbutton =(By.XPATH, "//*[contains(@resource-id,'follow_btn')]")
        addbutton = (By.XPATH, "//*[@text='09988']/../../..//*[contains(@resource-id, 'follow_btn')]")
        # followed_btn =(By.XPATH,"//*[contains(@resource-id,'followed_btn')]")
        followed_btn = (By.XPATH, "//*[@text='09988']/../../..//*[contains(@resource-id, 'followed_btn')]")
        self.driver.find_element(*addbutton).click()

        sleep(1)
        #tv_left
        next_talk_btn = (By.XPATH,"//*[contains(@resource-id,'tv_left')]")
        self.driver.find_element(*next_talk_btn).click()
        sleep(1)
        # price = (By.XPATH, "//*[@text='09988']/../../..//*[contains(@resource-id, 'current_price')]")
        # assert float(self.driver.find_element(*price).text) > 219
        assert (self.driver.find_element(*followed_btn).get_attribute("text")) == '已添加'
    ...
    def test_uiselector(self):
        scroll_to_element = (
            ...
            '.scrollIntoView('
            'new UiSelector().text("昨天10:53").instance(0));')
